...
<CardGroup cols={2}>
  ...
  <Card title="Resolver Pattern" icon="plug" href="/concepts/verification">
  ...
  <Card title="Horizon Indexer" icon="server" href="/reference/overview">
...
<CardGroup cols={2}>
  ...
  >
    Learn about Stellar implementation with Soroban smart contracts
  </Card>
  <Card
    title="API Reference"
    icon="server"
  ...
  >
    Complete API documentation for contract interactions and methods
  </Card>
  <Card
  ...
  >
    Build custom attestation schemas for your use cases
  </Card>
</CardGroup>
...
<Info>
**New to attestations?** Check out [What is AttestProtocol?](/guides/what-is-attestprotocol) to understand how Protocol contracts, Authority resolvers, and cryptographic delegation work together. Learn about [Core Concepts](/concepts/attestations) to get started building.
</Info>