...
<Warning>
**Get Test Credentials**: Generate test credentials at [laboratory.stellar.org](https://laboratory.stellar.org) and fund your account using the friendbot.
</Warning>
...
- Use the [friendbot](https://laboratory.stellar.org/#account-creator?network=test) to fund your account
</Accordion>
