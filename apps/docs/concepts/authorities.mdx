---
title: 'Authorities'
description: 'Everything you need to understand, become, and operate as an attestation authority in the AttestProtocol ecosystem'
---
...
Once approved, you'll appear in the Authority Directory and can begin issuing attestations.

[Apply to Become an Authority](https://attestprotocol.org/authorities/apply)

### Test Authority Sandbox

Use our testnet environments to prototype authority flows before going live.

**Related:** [Schema Standards](/concepts/schemas) | [Custom Schemas](/guides/custom-schemas)
...
All attestations must be cryptographically signed by the authority's private key and verifiable on-chain.

**Related:** [Trust Management](#trust-management) | [Revocation Management](#revocation-management)
...
[SDK Guide for Authorities](https://attestprotocol.org/docs/authority-sdk)
...
**Related:** [Verify Attestations](/concepts/verification) | [API Reference](/reference/overview)
...
Authorities can charge for each attestation issued — either directly (on-chain fees) or via their own billing systems.

**Example Revenue Models:**
- **Per-Attestation Fee:** $0.05–$2.00/attestation
- **Subscription Plans:** Monthly flat rate with issuance limits
- **Pay-per-Success:** Users pay only if verified

[Revenue Configuration Tool](https://attestprotocol.org/authorities/revenue)
...
**Related:** [Becoming an Authority](#becoming-an-authority)
...
All authorities are assigned a Trust Score based on their issuance volume, dispute resolution track record, and user feedback.
...
[Trust Layer Documentation](https://attestprotocol.org/docs/trust)
...
- [Apply to Become an Authority](https://attestprotocol.org/authorities/apply)
- [Launch Authority Dashboard](https://attestprotocol.org/authorities/dashboard)
- [View Authority Directory](https://attestprotocol.org/authorities/directory)
...
Connect with other authorities and shape the future of AttestProtocol:

[Join Governance Discussions](https://attestprotocol.org/governance)
...
<CardGroup cols={2}>
  <Card
    title="Authority Setup Guide"
    icon="gear"
    href="/guides/authority-setup"
  >
  ...
  <Card
    ...
    icon="database"
    href="https://attestprotocol.org/schemas"
  >
...
- [Schemas Overview](/concepts/schemas)
- [API Reference](/reference/overview)
- [Trust & Verification Layer](/concepts/verification)
- [Revocation Management](/guides/revocation)
