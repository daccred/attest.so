...
var require_base = __commonJS({
  "../sdk/dist/core/base.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.AttestSDKBase = void 0;
    var AttestSDKBase = class {
    };
    exports2.AttestSDKBase = AttestSDKBase;
  }
});

// ../sdk/dist/core/idl.json
var require_idl = __commonJS({
  "../sdk/dist/core/idl.json"(exports2, module2) {
    module2.exports = {
...
var require_solana = __commonJS({
  "../sdk/dist/core/solana.js"(exports2) {
    "use strict";
    ...
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.SolanaAttestSDK = void 0;
    ...
    var SolanaAttestSDK = class extends base_1.AttestSDKBase {
      constructor(config) {
        ...
        if (Array.isArray(config.walletOrSecretKey)) {
          const walletKeypair = web3_js_1.Keypair.fromSecretKey(Uint8Array.from(config.walletOrSecretKey));
        ...
        this.programId = config.programId ? new web3_js_1.PublicKey(config.programId) : new web3_js_1.PublicKey(idl_json_1.default.address);
      ...
      async createSchema(config) {
        try {
          const [authorityRecordPDA] = web3_js_1.PublicKey.findProgramAddressSync([Buffer.from("authority"), this.wallet.publicKey.toBuffer()], this.programId);
          const [schemaDataPDA] = web3_js_1.PublicKey.findProgramAddressSync([Buffer.from("schema"), this.wallet.publicKey.toBuffer(), Buffer.from(config.schemaName)], this.programId);
          const tx = await this.program.methods.createSchema(config.schemaName, config.schemaContent, config.resolverAddress, config.revocable ?? true, config.levy).accounts({
      ...
      async attest(config) {
        try {
          ...
          const tx = await this.program.methods.attest(config.data, config.refUID, config.expirationTime ? new anchor.BN(config.expirationTime) : null, config.revocable ?? true).accounts(accounts).transaction();
          await this._signTransaction(tx);
    ...
    exports2.SolanaAttestSDK = SolanaAttestSDK;
  }
});

// ../sdk/dist/core/stellar.js
var require_stellar = __commonJS({
  "../sdk/dist/core/stellar.js"(exports2) {
    "use strict";
    var __createBinding = exports2 && exports2.__createBinding || (Object.create ? function(o, m, k, k2) {
      if (k2 === void 0) k2 = k;
      var desc = Object.getOwnPropertyDescriptor(m, k);
    ...
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.StellarAttestSDK = void 0;
    var base_1 = require_base();
    ...
    var StellarAttestSDK2 = class extends base_1.AttestSDKBase {
      ...
      async attest(config) {
        try {
          const contract = new StellarSdk.Contract(this.contractId);
          const attestationId = this.generateAttestationId(config.schemaData.toString(), config.accounts.recipient.toString(), config.refUID?.toString() ?? null);
    ...
    exports2.StellarAttestSDK = StellarAttestSDK2;
  }
});

// ../sdk/dist/core/types.js
var require_types = __commonJS({
  "../sdk/dist/core/types.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
  }
});
...
var require_dist = __commonJS({
  "../sdk/dist/index.js"(exports2) {
    ...
    __exportStar(require_stellar(), exports2);
    __exportStar(require_solana(), exports2);
    var AttestSDK2 = class {
      static async initializeStellar(config) {
        const stellarClient = new stellar_1.StellarAttestSDK(config);
        await stellarClient.initialize();
        return stellarClient;
      }
      static async initializeSolana(config) {
        const solanaClient = new solana_1.SolanaAttestSDK(config);
        await solanaClient.initialize();
        return solanaClient;
      }
    };
    exports2.default = AttestSDK2;
  }
});
...
var handleJsonFile = async (jsonFile) => {
  try {
    const filePath = import_path.default.resolve(jsonFile);
...
var checkValidJSONContent = (schema) => {
...
var validateStellarSchema = (content) => {
  if (!content) {
...
var validateStellarAttestation = (content, schemaUid) => {
  if (!content) {
...
var BaseHandler = class {
  ...
  async initialize(signerKeyPath, url) {
    try {
      ...
      logger.log((0, import_picocolors.red)(`Error initializing client: ${error.message}`));
      return false;
    }
  }
  logAction(action, uid, isSchema) {
    ...
    if (action === "fetch" && uid) {
      logger.log((0, import_picocolors.green)(`Fetching ${entity} with UID: ${uid}`));
    } else if (action === "create") {
      logger.log((0, import_picocolors.green)(`Creating new ${entity}`));
    } else if (action === "revoke" && uid) {
      logger.log((0, import_picocolors.green)(`Revoking ${entity} with UID: ${uid}`));
    } else if (action === "register") {
      logger.log((0, import_picocolors.green)("Registering new authority"));
    }
  }
};
...
var StellarHandler = class extends BaseHandler {
  network = "testnet";
  // Default to testnet
  async initializeClient(secretKey) {
    try {
      ...
      logger.log((0, import_picocolors2.red)(`Failed to initialize Stellar client: ${error.message}`));
      throw error;
    }
  }
  ...
  async check(action, args) {
    ...
    if (args.content && typeof args.content === "object") {
      ...
      if (validationError) {
        logger.log((0, import_picocolors2.red)(`Validation error: ${validationError}`));
        return false;
      }
    }
    const initialized = await this.initialize(this.secretKey);
    if (!initialized) {
      logger.log((0, import_picocolors2.red)("Failed to initialize client"));
      return false;
    }
    switch (args.type) {
      case "schema":
      ...
      default:
        logger.log((0, import_picocolors2.red)(`Unknown type: ${args.type}`));
        return false;
    }
  }
  async handleSchema(action, args) {
    if (action === "fetch" && args.uid) {
      ...
      if (result.error) {
        logger.log((0, import_picocolors2.red)(`Error: ${result.error}`));
        return false;
      }
      if (!result.data) {
        logger.log((0, import_picocolors2.yellow)("No schema found with the given UID"));
        return false;
      }
  ...
  async handleAttestation(action, args) {
    if (action === "fetch" && args.uid) {
      ...
      if (!result.data) {
        logger.log((0, import_picocolors2.yellow)("No attestation found with the given UID"));
        return false;
      }
    ...
    if (action === "create" && args.schemaUid && args.content) {
      ...
      if (schemaResult.error) {
        logger.log((0, import_picocolors2.red)(`Error fetching schema: ${schemaResult.error}`));
        return false;
      }
      if (!schemaResult.data) {
        logger.log((0, import_picocolors2.red)(`Schema with UID ${args.schemaUid} not found`));
        return false;
      }
    ...
    if (action === "revoke" && args.uid) {
      ...
      if (!schemaUID) {
        logger.log((0, import_picocolors2.red)("Schema UID is required for revocation"));
        return false;
      }
      ...
      logger.log((0, import_picocolors2.green)("Attestation revoked successfully"));
  ...
  async handleAuthority(action) {
    ...
    if (action === "fetch") {
      ...
      if (!result.data) {
        logger.log((0, import_picocolors2.yellow)("No authority found for the current wallet"));
        return false;
      }
...
// src/commands/schema.ts
var command = "schema";
var describe = "Manage schemas (create, fetch)";
function builder(yargs) {
  return yargs.option("action", {
    type: "string",
...
async function handler(argv) {
  try {
    ...
    logger.log((0, import_picocolors3.red)(`Error: ${error.message}`));
  }
}
...
async function handler2(argv) {
  try {
    ...
    logger.log((0, import_picocolors4.red)(`Error: ${error.message}`));
  }
}
...
var command3 = "attestation";
var describe3 = "Manage attestations (create, fetch, revoke)";
var aliases = ["attest"];
...
async function handler3(argv) {
  try {
    ...
    logger.log((0, import_picocolors5.red)(`Error: ${error.message}`));
  }
}
