...
pub fn authority_registered(e: &Env, caller: &soroban_sdk::Address, authority: &soroban_sdk::Address, metadata: &soroban_sdk::String) {
    e.events().publish(
...
pub fn schema_registered(e: &Env, schema_uid: &soroban_sdk::BytesN<32>, rules: &crate::state::SchemaRules) {
    e.events().publish(
...
pub fn levy_collected(e: &Env, attester: &soroban_sdk::Address, recipient: &soroban_sdk::Address, schema_uid: &soroban_sdk::BytesN<32>, amount: i128) {
    e.events().publish(
